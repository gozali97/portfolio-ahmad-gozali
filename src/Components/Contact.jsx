...
export default function Contact(){
    return(
        <div id="contact" className="section flex justify-center pt-32 bg-gray-900">
            <section data-aos="fade-up">
                <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                    ...
                    <form action="#" className="space-y-8">
                        ...
                        <button type="submit" className="flex py-3 px-5 text-sm font-medium items-center text-white rounded-lg bg-blue-500 text-center hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300">Send message</button>
                        </div>
                    </form>
                </div>
            </section>

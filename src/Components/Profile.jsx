...
export default function Profile() {
  ...
  return (
    <div id="profile" className="py-10 bg-white dark:bg-gray-900 transition-colors duration-300">
      <div className="container mx-auto max-w-[1200px] p-6 overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row items-start justify-between gap-12">
          ...
          >
            ...
            <div className="bg-gray-100 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl p-6 border border-gray-300 dark:border-gray-700 w-full shadow-md">
          ...
          <div className="w-full lg:w-2/3">
            ...
            >
              {technicalSkills.map((skill, index) => (
                <div
                  key={index}
                  className="bg-gray-100 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl overflow-hidden border border-gray-300 dark:border-gray-700 hover:border-indigo-500/50 transition-all duration-300 group shadow-sm hover:shadow-md"
                >
                  <div className="p-6">
                    <div className="flex items-center mb-4">
                      <div className="w-12 h-12 mr-4 flex items-center justify-center bg-gray-200 dark:bg-gray-700 rounded-lg group-hover:bg-indigo-100 dark:group-hover:bg-indigo-600/20 transition-all duration-300">
                        <img
                          src={skill.image}
                          alt={skill.name}
                      ...
                      <div>
                        ...
                        <div className="flex items-center">
                          ...
                          <div className="w-1 h-1 bg-gray-400 dark:bg-gray-600 rounded-full mx-2"></div>
                          <span className="text-gray-600 dark:text-gray-400 text-sm">
                            {skill.proficiency}%
                          </span>
                        </div>
                    ...
                    <div className="mt-4 w-full bg-gray-300 dark:bg-gray-700 rounded-full h-1">
                      <div
            ...
            <div
              ...
              data-aos-duration="1000"
              data-aos-delay="200"
              className="mt-12 bg-gray-100 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl p-6 border border-gray-300 dark:border-gray-700 shadow-md"
            >
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">
                Career Highlights
              </h3>

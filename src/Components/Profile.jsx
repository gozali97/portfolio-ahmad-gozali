        ...
        <div id="profile" className="section">
            <div className="container mx-auto max-w-[1200px] p-3 overflow-hidden">
                <div className="font-secondary text-center font-bold mb-12 text-gray-100">
                    <h4 className="mb-2 text-gray-200">Awesome Skill</h4>
                    <h2 className="mb-2">My name is Ahmad Gozali.</h2>
                    <p className="text-sm">
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 text-center">
                            <div className="w-full">
                                <div className="bg-white h-full justify-center items-center flex rounded-lg overflow-hidden relative p-5 group">
                                    ...
                                    <div className="absolute p-5 backdrop-blur-xl bg-primary w-full h-full flex items-center opacity-0 scale-0 group-hover:scale-100 group-hover:opacity-100 transition duration-150 ease-linear">

                    ...
                    >
                        <div className="relative">
                            ...
                            <div className="relative max-w-[280px] max-h-[280px] rounded-full overflow-hidden border-4 border-gray-800">
                                <img className="w-full" src="/images/ahmad.jpg" alt="Ahmad Gozali - Senior Developer" />
                            </div>
                        </div>
                        
                        <h2 className="text-3xl font-bold mt-6 mb-3 text-white">Ahmad Gozali</h2>
                        <p className="text-indigo-400 font-medium mb-6">Full Stack Developer at PT Apotek K-24</p>
                        ...
                        <div className="bg-gray-800/70 backdrop-blur-sm rounded-xl p-6 border border-gray-700 w-full">
                            ...
                            <p className="text-gray-300 mb-4">
                                Senior developer with 5+ years of experience architecting and implementing enterprise-grade web applications. Graduated from Yogyakarta University of Technology with a degree in Informatics Engineering.
                            </p>
                            <p className="text-gray-300">
                                Proven track record of leading development teams and delivering high-quality solutions that meet business objectives and exceed client expectations.
                            </p>
                            
                            <div className="mt-6">
                                <h4 className="text-white font-medium mb-3">Professional Skills</h4>
                                        ...
                                        <div className="flex items-center mb-4">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center">
                                                    <span className="text-indigo-400 text-sm">{skill.years}+ years</span>
                        ...
                        >
                            ...
                            <ul className="space-y-4">
                                <li className="flex">
                                    ...
                                    <p className="text-gray-300">Led development of enterprise-level web applications, resulting in 40% improvement in system performance and user satisfaction.</p>
                                </li>
                                <li className="flex">
                                    <div className="flex-shrink-0 w-1.5 h-1.5 rounded-full bg-indigo-500 mt-2 mr-3"></div>
                                    <p className="text-gray-300">Implemented CI/CD pipelines and automated testing, reducing deployment time by 60% and improving code quality.</p>
                                </li>
                                <li className="flex">
                                    <div className="flex-shrink-0 w-1.5 h-1.5 rounded-full bg-indigo-500 mt-2 mr-3"></div>
                                    <p className="text-gray-300">Architected and developed scalable APIs serving 1M+ requests daily with 99.9% uptime.</p>
                                </li>
                                <li className="flex">
                                    <div className="flex-shrink-0 w-1.5 h-1.5 rounded-full bg-indigo-500 mt-2 mr-3"></div>
                                    <p className="text-gray-300">Mentored junior developers, improving team productivity by 30% and fostering knowledge sharing.</p>
                                </li>
                            </ul>
                        </div>
                    </div>

...
export default function Footer() {
  ...
  return (
    <footer className="bg-white dark:bg-gray-900 text-gray-900 dark:text-white py-16 transition-colors duration-300">
      <div className="container mx-auto max-w-6xl px-6">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="p-2 bg-blue-600 dark:bg-gray-700 hover:bg-indigo-600 text-white rounded-full transition-colors duration-300"
                aria-label="GitHub"
              >
          ...
          <div>
            ...
            <nav className="flex flex-col space-y-3">
              <Link
                ...
                className="dark:text-gray-300 hover:text-indigo-400 transition-colors duration-300 cursor-pointer w-fit"
              >
                Home
              </Link>
              <Link
          ...
          <div>
            ...
            <div className="mt-6">
              <a
                ...
                className="inline-flex items-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg transition-colors duration-300 shadow-md hover:shadow-lg"
                download
              >
        ...
        {/* Divider */}
        <div className="border-t border-gray-300 dark:border-gray-800 pt-8 mt-8"></div>
